...
if [ -f "I:\_Program Installs\Epic Games\4.11\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "I:\_Program Installs\Epic Games\4.11\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
